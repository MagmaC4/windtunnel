        ...
        <Card className="flex-1 flex items-center flex-col lg:flex-row justify-between">
            <div className="flex flex-col items-center lg:items-start">
                ...
                <div className="flex flex-row gap-2">
                    {/* Title */}
                    <p className="text-xl sm:text-2xl text-center lg:text-left text-title text-nowrap">{title}</p>
                    ...
                    {units && activeUnit &&
                        (<Button label={activeUnit.label}
                            ...
                            className="min-w-10 sm:min-w-20 bg-button-unit/90 hover:bg-button-unit border border-button-unit border-2 px-1 "/>
                        )
                    }
                </div>
